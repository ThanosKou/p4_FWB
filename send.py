...
def main():
    ...
    parser.add_argument('--dst_id', type=int, default=None, help='The FWB dst_id to use, if unspecified then FWB header will not be included in packet')
    parser.add_argument('--pkt_id', type=int, help="The packet ID in FWB header")
